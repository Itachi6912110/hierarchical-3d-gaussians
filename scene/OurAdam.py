...
def _single_tensor_adam(params: List[Tensor],
    ...
    for i, parami in enumerate(params):
        grad = grads[i][relevant] if not maximize else -grads[i]
        exp_avg = exp_avgs[i][relevant]
        exp_avg_sq = exp_avg_sqs[i][relevant]
        param = parami[relevant]
        ...
        if capturable:
            ...
            exp_avgs[i][relevant] = exp_avg
            exp_avg_sqs[i][relevant] = exp_avg_sq
